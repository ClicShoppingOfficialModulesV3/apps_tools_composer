<?php
  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    public function execute()
    {
      ...
      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_AppComposer->getDef('alert_module_uninstall_success'), 'success', 'AppComposer');
    ...
    private static function removeMenu()
    {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_tools_modules_app_composer');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_tools_modules_app_composer']);
      }
    }
  }