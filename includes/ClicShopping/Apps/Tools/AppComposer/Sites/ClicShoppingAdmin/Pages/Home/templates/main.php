...
<div class="contentBody">
  ...
  <div class="col-md-12 mainTitle">
    <strong><?php echo $CLICSHOPPING_AppComposer->getDef('text_modules_app_composer'); ?></strong></div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="form-group">
          <div class="col-md-12">
            <?php echo $CLICSHOPPING_AppComposer->getDef('text_intro'); ?>
          </div>
        </div>
        <div class="separator"></div>
        ...
        <div class="col-md-12 text-md-center">
          <div class="form-group">
            <div class="col-md-12">
              <?php
                echo HTML::form('configure', CLICSHOPPING::link(null, 'A&Tools\AppComposer&Configure'));
                echo HTML::button($CLICSHOPPING_AppComposer->getDef('button_configure'), null, null, 'primary');
                echo '</form>';
              ?>
            </div>
          </div>
